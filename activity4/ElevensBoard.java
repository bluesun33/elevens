...
public class ElevensBoard {
	...
	public boolean isLegal(List<Integer> selectedCards) {
		...
		if (selectedCards.size() == 3 && 
				numJack == 1 && numQueen == 1 && numKing == 1){
			return true;
		}
		else if (selectedCards.size() == 2 &&//need more work,
				cardAt(selectedCards.get(0)).pointValue() + cardAt(selectedCards.get(1)).pointValue() == 11){
			return true;
		}
		return false;
	}
	...
	private boolean containsPairSum11(List<Integer> selectedCards) {
		return false;/* *** TO BE IMPLEMENTED IN ACTIVITY 9 *** */
	}
