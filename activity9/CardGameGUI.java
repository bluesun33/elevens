...
public class CardGameGUI extends JFrame implements ActionListener {
	...
	private static final int r = (int) (screenSize.width / 800);
	/** Height of the game frame. */
	private static final int DEFAULT_HEIGHT = 302 * r;
	/** Width of the game frame. */
	private static final int DEFAULT_WIDTH = 800 * r;
	/** Width of a card. */
	private static final int CARD_WIDTH = 73  *r;
	/** Height of a card. */
	private static final int CARD_HEIGHT = 97 * r;
	/** Row (y coord) of the upper left corner of the first card. */
	private static final int LAYOUT_TOP = 30 * r;
	/** Column (x coord) of the upper left corner of the first card. */
	private static final int LAYOUT_LEFT = 30 * r;
	/** Distance between the upper left x coords of
	 *  two horizonally adjacent cards. */
	private static final int LAYOUT_WIDTH_INC = 100 * r;
	/** Distance between the upper left y coords of
	 *  two vertically adjacent cards. */
	private static final int LAYOUT_HEIGHT_INC = 125 * r;
	/** y coord of the "Replace" button. */
	private static final int BUTTON_TOP = 30 * r;
	/** x coord of the "Replace" button. */
	private static final int BUTTON_LEFT = 570 * r;
	/** Distance between the tops of the "Replace" and "Restart" buttons. */
	private static final int BUTTON_HEIGHT_INC = 50 * r;
	/** y coord of the "n undealt cards remain" label. */
	private static final int LABEL_TOP = 160 * r;
	/** x coord of the "n undealt cards remain" label. */
	private static final int LABEL_LEFT = 540 * r;
	/** Distance between the tops of the "n undealt cards" and
	 *  the "You lose/win" labels. */
	private static final int LABEL_HEIGHT_INC = 35 * r;
